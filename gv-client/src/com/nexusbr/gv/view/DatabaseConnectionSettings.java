...
public class DatabaseConnectionSettings extends JFrame {
	...
	public DatabaseConnectionSettings() {
		...
		lblDadosDaConexo.setFont(new Font("SansSerif", Font.BOLD, 14));
		lblDadosDaConexo.setBounds(0, 19, 469, 14);
		getContentPane().add(lblDadosDaConexo);
		
		panel = new JPanel();
		panel.setBackground(new Color(245, 245, 245));
		panel.setBorder(new LineBorder(new Color(192, 192, 192)));
		panel.setBounds(24, 39, 419, 111);
		...
		panel.add(lblPorta);
				...
				lblTipoDoBanco.setBounds(14, 27, 158, 14);
		...
		panel_1.setBounds(24, 160, 420, 101);
		...
		btnConectar.setBounds(78, 314, 106, 59);
		...
		btnCancelar.setBounds(282, 314, 106, 59);
	...
	public void connect(){
		try {
			DatabaseConnection.createXMLDatabaseConfig(this.getHost().getText(), this.getPassword().getText(),
